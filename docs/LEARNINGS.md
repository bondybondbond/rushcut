...
**Context:** `pipeline/encoder.py` `video_encoder_args()` if/when a `hevc_amf` branch is added. Full benchmark data: issue #85 (closed GO) + issue #110 (follow-up implementation, open).
